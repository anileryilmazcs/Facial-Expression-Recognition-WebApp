...
def index():
    ...
    flash('This is the interface of the application. Express your emotions with your facial expressions in the given time. After that, you can see the statistics about your emotions with changing url from "video_1" to "video_dash".')
...
# def video() :
#     # Display a warning message
#     flash('You will have 20 mintues to discuss the topic mentioned above. Due to restrictions, we are not able to redirect you once the video is over. Please move your URL to /video_dash instead of /video_1 once over. You will be able to see your results then.')
#     return render_template('video.html')
